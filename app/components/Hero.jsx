    ...
    <section className="relative h-[65vh] overflow-hidden flex items-center pt-24 md:pt-0">
      ...
      <div className="relative max-w-7xl mx-auto w-full px-6 grid md:grid-cols-2 items-center">
        ...
        >
          ...
          <motion.h1
            className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-black dark:text-white leading-tight flex gap-1 flex-wrap"
            initial="hidden"
            animate="visible"
            variants={{
          ...
          >
            {heroData.heroName.split("").map((char, idx) => (
              <motion.span
                key={idx}
                variants={{
